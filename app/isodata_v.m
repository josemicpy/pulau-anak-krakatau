...
function z = isodata_v(x)
  ...
  if (RANDOM == 1) % Asignacion aleatoria
    disp('Posicion inicial de centroides: Asignacion aleatoria');
    v = cell(N, 1);
    for n = 1:N
      b = 0;
      while b == 0
    ...
    disp('Posicion inicial de centroides: Asignacion centrada');
    v = cell(N, 1);
    for n = 1:N    
      for b = 1:B
